...
return [
    ...
    'dynamic_view_template' => [
            'index' => ['formHeadingHtml', 'formBodyHtml', 'crudName', 'crudNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'crudNameSingular','modelNameCap','viewTemplateDir','formBodyHtmlForShowView','varName','routePrefix','routePrefixCap','formSearchForShowView'],
            'form' => ['formFieldsHtml'],
            'create' => ['crudName', 'crudNameCap', 'modelName', 'modelNameCap', 'viewName', 'routeGroup', 'viewTemplateDir'],
            'edit' => ['crudName', 'crudNameSingular', 'crudNameCap', 'modelNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'viewTemplateDir','routePrefix','routePrefixCap'],
