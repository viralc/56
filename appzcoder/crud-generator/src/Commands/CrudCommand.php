...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $crudNameSingular = str_singular($name);
        ...
        if (file_exists($routeFile) && (strtolower($this->option('route')) === 'yes')) {
            ...
            $this->routeNames = strtolower($crudNameSingular);
            $this->routeGroupSingular = str_singular($routeGroup);
...
Route::get('$this->routeName', '$this->controller@index')->name('$this->routeGroupSingular.$this->routeNames.index');
Route::get('/$this->routeName/new', '$this->controller@form')->name('$this->routeGroupSingular.$this->routeNames.new');
Route::get('/$this->routeName/{{$this->routeNames}}', '$this->controller@form')->name('$this->routeGroupSingular.$this->routeNames.form');
Route::post('/$this->routeName/save', '$this->controller@post')->name('$this->routeGroupSingular.$this->routeNames.save');
Route::post('/$this->routeName/{{$this->routeNames}}/delete', '$this->controller@delete')->name('$this->routeGroupSingular.$this->routeNames.delete');
Route::post('/$this->routeName/{{$this->routeNames}}/restore', '$this->controller@restore')->name('$this->routeGroupSingular.$this->routeNames.restore');
Route::post('/$this->routeName/{{$this->routeNames}}/force-delete', '$this->controller@forceDelete')->name('$this->routeGroupSingular.$this->routeNames.force-delete');
EOT;
                return $snippet;
