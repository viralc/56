...
class CrudViewCommand extends Command
{
    ...
    protected $formSearchForShowView = '';
    ...
    public function handle()
    {
        ...
        $this->viewPath = $this->option('view-path') ? $this->option('view-path') . '.' : '';
        ...
        $this->routeNames = strtolower($this->crudNameSingular);
        $this->routeGroupSingular = str_singular($this->option('route-group'));


        $this->routePath = $this->option('route-group').'.'.$this->crudNameSingular;
        ...
        foreach ($this->formFields as $key => $value) {
            ...
            $this->formHeadingHtml .= '<td>' . $label . '</td>';
            $this->formBodyHtml .= '<td>{{$'.$this->crudNameSingular.'Item->' . $field . '}}</td>';
            $this->formBodyHtmlForShowView .= '<tr><th> ' . $label . ' </th><td> {{$'.$this->crudNameSingular.'->' . $field . ' }} </td></tr>';


            $this->formSearchForShowView .= "<div class='form-group'>{!! Form::label('".$field."', '".$field."', ['class' => 'col-sm-3']) !!}<div class='col-sm-9'>{!! Form::text('".$field."', Request::get('".$field."'), ['class' => 'form-control']) !!}</div></div>";
    ...
    {
        return [
            'index' => ['formHeadingHtml', 'formBodyHtml', 'crudName', 'crudNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'routePath', 'formSearchForShowView'],
            'form' => ['formFieldsHtml','formSearchForShowView'],
            'create' => ['crudName', 'crudNameCap', 'modelName', 'modelNameCap', 'viewName', 'routeGroup', 'viewTemplateDir', 'crudNameSingular', 'primaryKey' ],
            'edit' => ['crudName', 'crudNameSingular', 'crudNameCap', 'modelNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'viewTemplateDir', 'routePath', 'viewPath', 'routeGroupSingular', 'routeNames'],
